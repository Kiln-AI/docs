...
<figure><div style="position:relative;padding-bottom:56.25%;height:0;margin:1.5rem 0;"><iframe src="https://player.vimeo.com/video/1067942685?h=f2fbe3e3de" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;border-radius:8px" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen title="Video"></iframe></div><figcaption><p>Video walkthrough of creating a custom reasoning LLM</p></figcaption></figure>
...
See below for [how to choose between reasoning and chain of thought](/docs/fine-tuning/guide-train-a-reasoning-model/#choosing-between-reasoning-and-chain-of-thought).

<figure style="max-width:375px">

![](../../../../assets/run-method.png)

<figcaption><p>Synthetic Data Run Options</p></figcaption>
</figure>
...
![](../../../../assets/filter-to-reasoning.png)

<figcaption><p>Filtering your training dataset</p></figcaption>
</figure>
...
![](../../../../assets/Screenshot-2025-05-26-at-9.18.25-PM.png)

<figcaption><p>Select this on the "Create Fine Tune" screen</p></figcaption>
</figure>
...
<figure style="max-width:341px">

![](../../../../assets/Screenshot-2025-02-05-at-9.56.17-AM.png)

<figcaption><p>Kiln's Inference UI Options</p></figcaption>
</figure>
...
* Use human-led chain of thought prompts as described [here](/docs/fine-tuning/guide-train-a-reasoning-model/#choosing-between-reasoning-and-chain-of-thought), to generate [large synthetic data sets](/docs/synthetic-data-generation/) for fine-tuning.
