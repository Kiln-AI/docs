...
* \[2 mins]: [Define task, goals, and schema](/docs/fine-tuning/fine-tuning-guide/#step-1-define-your-task-and-goals)
* \[9 mins]: [Synthetic data generation](/docs/synthetic-data-generation/): create 920 high-quality examples for training
* \[5 mins]: Dispatch 9 fine tuning jobs: [Fireworks](/docs/fine-tuning/fine-tuning-guide/#step-4-dispatch-training-jobs) (Llama 3.2 1b/3b/11b, Llama 3.1 8b/70b, Mixtral 8x7b), [OpenAI](/docs/fine-tuning/fine-tuning-guide/#step-4-dispatch-training-jobs) (GPT 4o, 4o-Mini), and [Unsloth](/docs/fine-tuning/fine-tuning-guide/#step-6-optional-training-on-your-own-infrastructure) (Llama 3.2 1b/3b). Note: since this guide was written we've added over 60 new models for fine tuning!
* \[2 mins]: [Deploy your new models and test they work](/docs/fine-tuning/fine-tuning-guide/#step-5-deploy-and-run-your-models)

Analysis:

* [Cost Breakdown](/docs/fine-tuning/fine-tuning-guide/#cost-breakdown)
* [Next steps](/docs/fine-tuning/fine-tuning-guide/#next-steps): evaluation, exporting models, iteration and data strategies
...
<figure><video controls playsinline style="width:100%;border-radius:8px;margin:1.5rem 0" src="/assets/CreateTask720.mp4"></video><figcaption><p>Create a task to fine-tune for</p></figcaption></figure>
...
<figure><video controls playsinline style="width:100%;border-radius:8px;margin:1.5rem 0" src="/assets/Datagen720.mp4"></video><figcaption><p>Synthetic Data Generation</p></figcaption></figure>
...
<figure><video controls playsinline style="width:100%;border-radius:8px;margin:1.5rem 0" src="/assets/CreateTrainingJobs720.mp4"></video><figcaption><p>Dispatching Training Jobs. Note: video does not match current UI</p></figcaption></figure>
...
<figure><video controls playsinline style="width:100%;border-radius:8px;margin:1.5rem 0" src="/assets/Run720.mp4"></video><figcaption><p>Running some of our Fine Tuned Models (Llama 3.2 1b &amp; GPT 4o-mini)</p></figcaption></figure>
...
<figure><video controls playsinline style="width:100%;border-radius:8px;margin:1.5rem 0" src="/assets/Unsloth720.mp4"></video><figcaption><p>Unsloth Demo</p></figcaption></figure>
...
<figure style="max-width:287px">

![](../../../../assets/Screenshot-2025-03-19-at-7.27.16-PM.png)

<figcaption><p>Weights and Biases Metrics</p></figcaption>
</figure>
