...
<div style="position:relative;padding-bottom:56.25%;height:0;margin:1.5rem 0;"><iframe src="https://www.youtube.com/embed/qh0FIrLMrII" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;border-radius:8px" allow="accelerometer; autoplay; clipboard-write; encrypted-media; picture-in-picture" allowfullscreen title="Video"></iframe></div>
...
![](../../../../assets/Screenshot-2025-09-04-at-1.47.57-PM.png)

<figcaption><p>Example tools on the "Add Tools" screen</p></figcaption>
</figure>
...
![](../../../../assets/Screenshot-2025-09-04-at-1.45.40-PM.png)

<figcaption><p>Example dependency warning</p></figcaption>
</figure>
...
* Environment variables: a list of environment variables. Be sure to specify which are secrets (like API keys), so that these aren't synced into your Kiln project on Git ([more info](/docs/tools-and-mcp/#secret-management)).
...
* Headers: a list of headers to pass when calling the remote MCP server. Be sure to specify which are secrets (like API keys), so that these aren't synced into your Kiln project on Git ([more info](/docs/tools-and-mcp/#secret-management)).
...
<figure style="max-width:182px">

![](../../../../assets/Screenshot-2025-09-04-at-2.08.06-PM.png)
...
![A Trace Including Tool Calls](../../../../assets/Screenshot-2025-09-22-at-11.49.42-AM.png)

<figcaption><p>A Trace Showing a Tool Call</p></figcaption>
</figure>
...
![](../../../../assets/Screenshot-2025-09-05-at-2.24.36-PM.png)

<figcaption><p>Ignore the warnings at your peril</p></figcaption>
</figure>
...
![](../../../../assets/Screenshot-2025-09-05-at-3.42.28-PM.png)

<figcaption><p>Identify secrets on tool setup</p></figcaption>
</figure>
