...
<a href="/docs/evals-and-specs/specifications/" class="button secondary">Try the Kiln Eval Builder</a>
:::
...
<figure><div style="position:relative;padding-bottom:56.25%;height:0;margin:1.5rem 0;"><iframe src="https://player.vimeo.com/video/1067948856" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;border-radius:8px" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen title="Video"></iframe></div><figcaption><p>Video walkthrough of creating a LLM evaluator</p></figcaption></figure>
...
* [Creating an Evaluator](/docs/evals-and-specs/evaluations/#creating-an-eval)
* [Add a Judge to your Eval](/docs/evals-and-specs/evaluations/#add-a-judge-to-your-eval)
* [Create your Eval Datasets](/docs/evals-and-specs/evaluations/#create-your-eval-datasets)
* [Finding the Ideal Judge](/docs/evals-and-specs/evaluations/#finding-the-ideal-judge)
* [Finding the Ideal Run Method](/docs/evals-and-specs/evaluations/#finding-the-ideal-run-method)
* [Iterate and Expand](/docs/evals-and-specs/evaluations/#iterate-and-expand)

<figure style="max-width:188px">

![](../../../../assets/Screenshot-2025-06-27-at-10.52.26-AM.png)

<figcaption><p>Kiln's UI will guide you</p></figcaption>
</figure>
...
Most commonly, you'll want to populate the datasets using synthetic data. Clicking `Add Eval Data` then `Synthetic Data` from the Evals UI; this will launch the synthetic data gen tool with the proper [eval tags](/docs/evals-and-specs/evaluations/#defining-your-dataset-with-tags) already populated. See our [synthetic data generation guide](/docs/synthetic-data-generation/) for details on generating synthetic data.
...
![](../../../../assets/Screenshot-2025-07-16-at-12.52.18-PM.png)

<figcaption><p>Data gen will populate target tags when launched from Evals</p></figcaption>
</figure>
...
![](../../../../assets/Screenshot-2025-06-27-at-11.13.51-AM.png)
...
<figure style="max-width:179px">

![](../../../../assets/Screenshot-2025-06-27-at-11.20.02-AM.png)

<figcaption><p>Select the default judge</p></figcaption>
</figure>
...
![](../../../../assets/Screenshot-2025-07-17-at-1.39.06-PM.png)

<figcaption><p>Comparing several run methods across all evals</p></figcaption>
</figure>
...
![](../../../../assets/Screenshot-2025-07-17-at-2.16.51-PM.png)
