---
title: "Evaluate Appropriate Tool Use"
...
A Tool Call Check doesn't approximate human judgement, so there's no judge to align: you don't need a golden dataset, human ratings, or the [Compare Judges](/docs/evals-and-specs/evaluations/#finding-the-ideal-judge) flow. Populate your test dataset and go straight to [comparing run methods](/docs/evals-and-specs/evaluate-appropriate-tool-use/#finding-the-ideal-run-configuration).
...
![](../../../../assets/Screenshot-2025-11-14-at-1.33.24-PM.png)

<figcaption><p>Comparing Run Configurations</p></figcaption>
</figure>
