...
* [Tool Use](/docs/agents/#tool-use)
* [Multi-Actor Interaction (aka subtasks)](/docs/agents/#multi-actor-interaction-aka-subtasks)
* [Goal Directed, Autonomous Looping & Reasoning](/docs/agents/#goal-directed-autonomy--reasoning)
* [State & Memory](/docs/agents/#state--memory)
...
![](../../../assets/subtask-diagram.png)

<figcaption><p>A Kiln task, able to call other Kiln tasks as tools</p></figcaption>
</figure>
...
![](../../../assets/Screenshot-2025-10-03-at-1.48.21-PM.png)

<figcaption><p>Creating a run configuration in the "Run" tab</p></figcaption>
</figure>
...
![](../../../assets/Screenshot-2025-10-03-at-1.58.39-PM.png)

<figcaption><p>Creating a Kiln Task as Tool</p></figcaption>
</figure>
...
![](../../../assets/Screenshot-2025-10-03-at-2.10.42-PM.png)

<figcaption><p>Adding a Kiln task as tool subtask</p></figcaption>
</figure>
...
![](../../../assets/Screenshot-2025-10-03-at-2.16.13-PM.png)
...
Currently Kiln maintains memory simply through the message history. See the [context management](/docs/agents/#context-management) section above for how to use Kiln subtasks to compress memory, summarizing many subtask messages into a shorter summaries in the main-task history.
