...
* [**Kiln Pro Batch Planning**](/docs/synthetic-data-generation/generating-synthetic-data/#kiln-pro-plan-the-batch)**:** describe the dataset you want and Kiln plans the whole dataset for you, writing one tailored prompt per sample to cover your task's use cases and edge cases.
* [**Manual Generation**](/docs/synthetic-data-generation/generating-synthetic-data/#manual-build-a-topic-tree)**:** plan the coverage yourself by building a tree of topics for breadth.
...
<table><thead><tr><th valign="middle"></th><th valign="middle">Manual</th><th valign="middle">Kiln Pro</th></tr></thead><tbody><tr><td valign="middle"><strong>Effort</strong></td><td valign="middle">~15 min</td><td valign="middle">~5 min</td></tr><tr><td valign="middle"><strong>Use Case Coverage</strong></td><td valign="middle">Manual</td><td valign="middle">AI Planned</td></tr><tr><td valign="middle"><strong>Edge Case Coverage</strong></td><td valign="middle">Manual</td><td valign="middle">AI Planned</td></tr><tr><td valign="middle"><strong>Kiln Account</strong></td><td valign="middle">Optional</td><td valign="middle">Required</td></tr></tbody></table>
...
1. **Plan or Topics:** Kiln Pro [**plans the whole batch**](/docs/synthetic-data-generation/generating-synthetic-data/#kiln-pro-plan-the-batch) up front; manual mode [**builds a topic tree**](/docs/synthetic-data-generation/generating-synthetic-data/#manual-build-a-topic-tree) for breadth.
2. [**Inputs**](/docs/synthetic-data-generation/generating-synthetic-data/#generate-inputs): generate synthetic model inputs (the user message).
3. [**Outputs**](/docs/synthetic-data-generation/generating-synthetic-data/#generate-outputs): run your task on the inputs to generate synthetic outputs.
4. [**Save Data**](/docs/synthetic-data-generation/generating-synthetic-data/#save-your-data): save your curated data into your dataset for use in evals and fine-tuning.
...
Kiln offers 2 ways to plan entire deadsets: [Kiln Pro Batch Planning](/docs/synthetic-data-generation/generating-synthetic-data/#kiln-pro-plan-the-batch) and [Manual Topic Trees](/docs/synthetic-data-generation/generating-synthetic-data/#manual-build-a-topic-tree).
...
* **Use Data Guide:** include your task's [Data Guide](/docs/synthetic-data-generation/generating-synthetic-data/#set-up-a-data-guide), so both the plan and the generated inputs match the shape of your real data.
...
<figure><div style="position:relative;padding-bottom:56.25%;height:0;margin:1.5rem 0;"><iframe src="https://player.vimeo.com/video/1088940292" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;border-radius:8px" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen title="Video"></iframe></div><figcaption><p>Synthetic Data Generation Walkthrough</p></figcaption></figure>
...
The data will automatically be tagged with appropriate tags, based on the goal you selected ([see details](/docs/synthetic-data-generation/generating-synthetic-data/#tagging)):
...
:::note
Kiln Pro works differently: it plans the whole batch from a single prefilled **Guidance** box, with no template dropdown or per-stage guidance. See [Kiln Pro: Plan the Batch](/docs/synthetic-data-generation/generating-synthetic-data/#kiln-pro-plan-the-batch).
:::
