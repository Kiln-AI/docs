...
1. [Adding Documents](/docs/documents-and-search-rag/#adding-documents): Drag and drop files into the Kiln document library
2. [Create a search tool](/docs/documents-and-search-rag/#building-a-search-tool): specify how you want Kiln to search the documents
3. [Use the tool](/docs/documents-and-search-rag/#using-search-tools): Select the search tool when running your task

See our Video Guide if you prefer video format:

<div style="position:relative;padding-bottom:56.25%;height:0;margin:1.5rem 0;"><iframe src="https://player.vimeo.com/video/1138141451" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;border-radius:8px" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen title="Video"></iframe></div>
...
![](../../../assets/Screenshot-2025-09-17-at-8.00.42-PM.png)

<figcaption><p>The Add Documents dialog</p></figcaption>
</figure>
...
<figure style="max-width:335px">

![](../../../assets/Screenshot-2025-09-17-at-7.57.10-PM.png)

<figcaption><p>Managing tags from the document's detail page</p></figcaption>
</figure>
...
After adding documents, Kiln must process them before they can be searched. You can monitor progress on the "Search Tools (RAG)" page. See [how it works](/docs/documents-and-search-rag/#how-it-works) below for more information about what each step is doing.

<figure style="max-width:187px">

![](../../../assets/image-1.png)

<figcaption><p>Waiting on Processing</p></figcaption>
</figure>

### Using Search Tools

Once you’ve [created a search tool](/docs/documents-and-search-rag/#building-a-search-tool) and [processing is complete](/docs/documents-and-search-rag/#processing-documents), you can run your search tools!
...
![](../../../assets/Screenshot-2025-09-18-at-2.27.11-PM.png)

<figcaption><p>Selecting a search tool in "Run"</p></figcaption>
</figure>
...
![](../../../assets/Screenshot-2025-09-18-at-2.29.03-PM.png)

<figcaption><p>A trace including a tool call to a search tool</p></figcaption>
</figure>

:::note
It’s the model’s choice if and when to invoke a tool. If the model isn’t invoking search when you feel it should, see the section below on [optimizing your RAG](/docs/documents-and-search-rag/#step-1-optimize-search-tool-name-description-and-task-prompt).
:::
...
![](../../../assets/Screenshot-2025-09-18-at-2.18.57-PM.png)

<figcaption><p>A search tool test invocation</p></figcaption>
</figure>
...
* Manually review search result quality in the [search tool test UI](/docs/documents-and-search-rag/#testing-your-search-tool)
...
* Make the search tool name and description more descriptive: [example and guidance](/docs/documents-and-search-rag/#search-tool-name--description).
...
<div style="position:relative;padding-bottom:56.25%;height:0;margin:1.5rem 0;"><iframe src="https://player.vimeo.com/video/1138970149" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;border-radius:8px" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen title="Video"></iframe></div>
