...
Currently this data is used in [repair prompts](/docs/prompts/prompt-generators/#prompt-generators): a prompt style that includes both all of the data above in a multi-shot prompt format.
