...
* [Custom Prompts](prompts.md#custom-prompts): manuall create, save and share any prompt.
...
* Try our [prompt optimizer](prompts/automatic-prompt-optimizer.md) to find the best prompt for your task using evals. It works like a human refining a prompt would, but running thousands of tests to optimize and refine.
