...
To find the optimal prompt, Kiln Prompt Optimizer combines [Kiln Evals](../evals-and-specs/), synthetic training dataset generation, and algorithmic reflective prompt evolution.
...
We can't optimize something unless we can measure it, so the heart of our prompt optimizer is [Kiln Evals](../evals-and-specs/).
...
1. **Create one or more** [**evals**](../evals-and-specs/) that define the desired behaviour of your product.
