...
Like [skills](../skills.md#creating-skills), the description is the model's only signal about when to use this tool. "Look up a user by ID and return their profile" beats "user tool".
{% endhint %}
...
* [Code Judges](../evals-and-specs/code-judges.md): the same Python model, used to score evals
