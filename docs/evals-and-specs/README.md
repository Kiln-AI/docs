...
* **Specs:** A more comprehensive system for evaluating AI systems. It includes evals and adds synthetic evaluation data generation, edge case detection, judge prompt generation, and more.
