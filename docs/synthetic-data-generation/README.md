...
* **Evals:** Generate data for custom evals of your task performance. When your eval is scored by a [programmatic judge](../evals-and-specs/judge-types.md), data generation reads the check's definition and creates inputs designed to expose its failures.
